defmodule VehiclesMock do
  ...
  def set_summary(name, summary), do: GenServer.call(name, {:set_summary, summary})
  ...
  def handle_call({:set_summary, summary}, _from, %State{} = state) do
    {:reply, :ok, %{state | summary: summary}}
  end
