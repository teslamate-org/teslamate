defmodule TeslaMate.Vehicles.Identification do
  ...
  defp get_efficiency("S", "60D"), do: 0.187
  defp get_efficiency("S", "70"), do: 0.200
  defp get_efficiency("S", "70D"), do: 0.194
