defmodule TeslaMate.Vehicles.Identification do
  ...
  defp get_efficiency("MX", "BTX4", false, _), do: {"X 90D", 0.208}
  defp get_efficiency("MX", "BTX4", true, _), do: {"X P90D", 0.217}
  ...
  defp get_efficiency("M3", "BT37", true, _), do: {"3P", 0.153}
  defp get_efficiency("M3", "BT37", false, _), do: {"3", 0.153}
