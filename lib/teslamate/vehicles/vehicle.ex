defmodule TeslaMate.Vehicles.Vehicle do
  ...
  def handle_event(
    ...
    {:next_state, :start, %Data{data | last_used: data.deps.clock.utc_now(), driving_status: nil},
     schedule_fetch(data)}
  end
  ...
  def handle_event(
    ...
    cond do
      has_gained_range? and offline_min >= 5 ->
        ...
        {:next_state, :start, %{data | last_used: data.deps.clock.utc_now(), driving_status: nil},
  ...
  def handle_event(
    ...
    case vehicle do
      ...
      %Vehicle{drive_state: %Drive{shift_state: shift_state}} when shift_state in [nil, "P"] ->
        ...
        {:next_state, :start,
         %{data | last_used: data.deps.clock.utc_now(), driving_status: nil, geofence: geofence},
