...
| `teslamate/cars/$car_id/driver_front_window_open`      | false                                                                                       | Indicates if the driver-side front window is open                                     |
| `teslamate/cars/$car_id/driver_rear_window_open`       | false                                                                                       | Indicates if the driver-side rear window is open                                      |
| `teslamate/cars/$car_id/passenger_front_window_open`   | false                                                                                       | Indicates if the passenger-side front window is open                                  |
| `teslamate/cars/$car_id/passenger_rear_window_open`    | false                                                                                       | Indicates if the passenger-side rear window is open                                   |
...
| `teslamate/cars/$car_id/sun_roof_state`                | open                                                                                        | Current sunroof state                                                                 |
| `teslamate/cars/$car_id/sun_roof_installed`            | true                                                                                        | Indicates if the vehicle has a sunroof                                                |
| `teslamate/cars/$car_id/sun_roof_percent_open`         | 80                                                                                          | Current sunroof open percentage                                                       |
