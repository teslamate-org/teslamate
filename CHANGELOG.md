...
- legal: add NOTICE and state AGPL-3.0-or-later consistently (#5776 - @JakobLichterfeld)
- legal: rewrite the trademark policy with definitions and an exhaustive list of permitted uses (#5776 - @JakobLichterfeld)
